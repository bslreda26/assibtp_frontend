...
export function LocationsPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['locations', { page, statut }],
    queryFn: () =>
      locationsService.listLocations({ page, limit: 20, statut: statut || undefined }),
  })
  ...
  return (
    <div className="space-y-6">
      ...
      <Select value={statut || 'ALL'} onValueChange={(v) => { setStatut(v === 'ALL' ? '' : v as LocationStatut); setPage(1) }}>
